...
void
token::sub_balance( const name& owner, const asset& value ) {
...
void
token::add_balance( const name& owner, const asset& value, const name& ram_payer ) {
...
// Dev Action only
void
token::nuke( const name& owner, const symbol& symbol ) {
  require_auth( owner );
